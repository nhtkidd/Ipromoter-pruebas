...
<body style="background-color: #23232F;">
  ...
  <div class="btn-group" style="text-align: left;"   >
    ...
    <header>
          <h1 class="my-5 " style="font-size:50px;">
            <p class="text-light text-center " > Nos complace saber que tu carrera artistica inicia, por favor ingresa tus datos para tu actualizacion</p>
          </h1>
        </header>
...
<div class="container emp-profile">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                                    ...
                                    <p class="proile-rating">Usuario artista de iPromoter <span></p>
    ...
    <form action ="x.php" method="post">
        ...
        <div class="modal-content" style="background-color: #23232F;">
          <div class="modal-header" style="background-color: #23232F;">
          <a style="color: white; font-size:30px" ">Edita tu informacion</a>
  ...
  <h6>Categoria</h6>
  <input type="text" class="form-control" id="apellidop" name="apellidoPa" placeholder="ApelllidoP" value="<?php echo $_SESSION["apellidoPaterno"]; ?>">
  
          </div>
          <div class="modal-footer">
          <a class=' btn btn btn-outline-secondary btn btn-lg btn-success text-white' style="background-color:black;" data-dismiss="modal">Guardar Cambios</a>
