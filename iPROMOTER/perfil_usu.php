...
<div class="container emp-profile">
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-2">
                    <a href="edit_usu.php" class="btn btn-primary btn-lg " style="background-color:black;" role="button" aria-disabled="true">Editar</a>
                    </div>
                </div>
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p><?php echo $_SESSION["apellidoPaterno"] ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                            <p><?php echo $_SESSION["apellidoMaterno"] ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p><?php echo $_SESSION["contraseña"] ?></p>
                                            </div>
                                        </div>
